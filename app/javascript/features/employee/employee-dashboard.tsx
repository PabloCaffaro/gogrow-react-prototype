...
function NavigationItem({
  ...
  return (
    <button className={styles.navigationItem} data-active={active} type="button">
    ...
    <div className={styles.page}>
      <aside className={styles.desktopSidebar}>
        ...
        <nav className={styles.desktopNavigation} aria-label="Navegación principal">
          <NavigationItem icon={UtensilsCrossed} label="Menú" active />
          <NavigationItem icon={ClipboardList} label="Pedidos" />
          <NavigationItem icon={DollarSign} label="Pagos" />
          <NavigationItem icon={UserRound} label="Cuenta" />
        </nav>
      ...
      <main className={styles.workspace}>
        <header className={styles.desktopHeader}>
          ...
          <button className={styles.settingsButton} type="button" aria-label="Configuración">
            <Settings2 aria-hidden="true" />
          </button>
        </header>

        <div className={styles.mobileIntro}>
          <h1>Hola, Sofi <span aria-hidden="true">👋</span></h1>
            ...
            <section className={styles.selectionCard}>
              ...
              {selectedDish ? (
                <>
                  ...
                  <button className={styles.continueButton} type="button">Continuar pedido</button>
                </>
              ) : (
